...
app.run(function($rootScope, $location, $cookies, $state, $http, $menuItems, $timeout)
{
...
//	var role = [0, 1, 2, 3];
	var permission = {
		0: {
			"accessibleState": ["login","logout","app.gamestate","app.tribes", "app.timezone","app.usersmanagement","app.textstring", "app.profanity", "app.news","app.analysis-IAP", "app.analysis-DAU", "app.analysis-adjustcallback","app.gamedata","app.bundle","app.gamesettings", "app.sendemail", "app.notification", "app.gameversion"]
		},
		1: {
			"accessibleState": ["login","logout","app.gamestate","app.tribes", "app.timezone","app.usersmanagement", "app.gameversion"]
		},
		2: {
			"accessibleState": ["login","logout","app.textstring", "app.profanity", "app.news", "app.gameversion"]
		},
		3: {
			"accessibleState": ["login","logout","app.analysis-IAP", "app.analysis-DAU", "app.analysis-adjustcallback", "app.gameversion"]
		},
		4: {
			"accessibleState": ["login","logout","app.gamedata", "app.gameversion"]
		},
		5: {
			"accessibleState": ["login","logout","app.bundle","app.gamesettings", "app.sendemail", "app.notification", "app.gameversion"]
		},
	}
...
//			}
      ...
      templateUrl: 'users',
			...
			url: '/timezone',
			templateUrl: 'timezone',
			controller: 'TimeZoneCtrl',
		}).
		state('app.gameversion', {
			url: '/gameversion',
			templateUrl: 'gameversion',
			resolve: {
				deps: function($ocLazyLoad){
					return $ocLazyLoad.load([
						ASSETS.tables.datatables,
		...
		state('loading', {
			url: '/loading',
			templateUrl: appHelper.templatePath('loading'),
		});
});
