...
angular.module('xenon.services', []).
	service('$menuItems', function()
	{
		...
		this.getMenuForAdmin = function()
		{
			...
			this.menuItems[0].addItem('Custom-Made Report', 		'/app/custommadereport', 			'linecons-star');
			...
			this.menuItems[0].addItem('Game Data (Static)', 		'/app/gamedata', 			'linecons-database');
			this.menuItems[0].addItem('Game Settings', 		'/app/gamesettings', 			'linecons-cog');
			this.menuItems[0].addItem('Bundle', 		'/app/bundle', 			'linecons-photo');
			this.menuItems[0].addItem('User Management', 		'/app/usersmanagement', 			'linecons-photo');
