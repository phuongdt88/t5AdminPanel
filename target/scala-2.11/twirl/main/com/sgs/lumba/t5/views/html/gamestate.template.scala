...
<script>
	;(function($)
	"""),format.raw/*868.2*/("""{"""),format.raw/*868.3*/("""
		"""),format.raw/*869.3*/("""$('.table-responsive').responsiveTable();
	"""),format.raw/*870.2*/("""}"""),format.raw/*870.3*/(""")(jQuery);
</script>"""))
      }
    }
  }
...
object gamestate extends gamestate_Scope0.gamestate
              /*
                  ...
                  SOURCE: /Users/phuongdt1/Desktop/lumba/t5-admin-panel/app/com/sgs/lumba/t5/views/gamestate.scala.html
                  HASH: f68973fce404fb7cb030406cc6eb96df26c4c58f
                  MATRIX: 852->0|27956->27056|27985->27057|28016->27060|28087->27103|28116->27104
                  LINES: 32->1|900->868|900->868|901->869|902->870|902->870
                  -- GENERATED --
              */
